...
def parse_args():
    ...
    dd parser.add_argument('--env', default='Visual-UR5-min-time', type=str)
    ...
    dd parser.add_argument('--random_action_repeat', default=1, type=int)
    dd parser.add_argument('--agent_action_repeat', default=1, type=int)
    dd parser.add_argument('--image_history', default=3, type=int)
    dd parser.add_argument('--joint_history', default=1, type=int)
    dd parser.add_argument('--ignore_joint', default=False, action='store_true')
    dd parser.add_argument('--episode_length_time', default=30.0, type=float)
    ...
    dd parser.add_argument('--env_steps', default=120000, type=int)
    ...
    dd parser.add_argument('--bootstrap_terminal', default=0, type=int)
    # actor
    ...
    # sac
    dd parser.add_argument('--discount', default=1.0, type=float)
    ...
    # misc
    dd parser.add_argument('--description', default='size_margin=20', type=str)
    dd parser.add_argument('--seed', default=8, type=int)
    dd parser.add_argument('--work_dir', default='.', type=str)
    dd parser.add_argument('--save_tb', default=False, action='store_true')
    dd parser.add_argument('--save_model', default=True, action='store_true')
    #parser.add_argument('--save_buffer', default=False, action='store_true')
    dd parser.add_argument('--save_model_freq', default=10000, type=int)
    dd parser.add_argument('--load_model', default=-1, type=int)
    dd parser.add_argument('--device', default='cuda:0', type=str)
    dd parser.add_argument('--lock', default=False, action='store_true')
