...
def main():
    ...
    args.proprioception_shape = (11, )
    args.action_shape = (2, )
    args.net_params = config
    args.env_action_space =Box(-1, 1, (2,))
    ...
    image, propri = (None, np.random.uniform(-1, 1, (11,)))
    ...
    for step in range(args.env_steps + args.init_steps):
        ...
        next_image, next_propri, reward, done, _ = (None, np.random.uniform(-1, 1, (11,)), -1, False, None)
        ...
        if done or (episode_step == episode_length_step): # set time out here
            ...
            next_image, next_propri = (None, np.random.uniform(-1, 1, (11,)))
