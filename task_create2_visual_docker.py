...
from envs.create2_visual_docker.env import Create2VisualDockerEnv
...
def parse_args():
    ...
    # environment
    parser.add_argument('--target_type', default='create2_visual_docker', type=str)
