...
from envs.create2_visual_aligner.env import Create2VisualAlignerEnv
...
def parse_args():
    ...
    # environment
    parser.add_argument('--target_type', default='create2_visual_aligner', type=str)
